...
import { User, Mail, Phone, Shield, Edit3, Save, X, Check } from "lucide-react";
...
export const ProfilePage = ({ user, updateProfile }: ProfilePageProps) => {
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        {!isEditing ? (
          <button
            onClick={handleEdit}
            className="flex items-center gap-2 px-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-gray-300 hover:text-white hover:border-gray-600 transition-all duration-300"
          >
            <Edit3 size={16} />
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-gray-400 hover:text-white transition-all duration-300"
            >
              <X size={16} />
              <span>Cancel</span>
            </button>
